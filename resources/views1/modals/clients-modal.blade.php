        ...
        <div class="modal-body">
            ...
            <div class="row g-3 mt-2">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="Image" class="fw-normal  bg-primary px-4 py-1 text-white rounded required">Building Name</label><br>
          ...
          <div class="col-md-6">
              ...
              <input type="text" name="" id="" class="form-control" wire:model="crep_name">
...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="editClientModal" tabindex="-1" aria-labelledby="editClientModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
