...
<div class="d-flex" id="wrapper">
    ...
    <div class=" bg-primary" id="sidebar-wrapper">
        <div class="sidebar-heading border-bottom bg-primary fw-bolder text-white cursive">Rudra Connect</div>
        <div class="menu-list-group menu-list-group-flush mt-2">
			...
			<a class="menu-list-group-item menu-list-group-item-action menu-list-group-item-dark bg-primary border-0 text-white text-white p-3 @if($route=='reports.reports' || $route == 'reports.filter') activeNav @endif" href="/reports"><i class="fa fa-bar-chart me-1"></i> Reports </a>  
