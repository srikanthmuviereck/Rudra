...
class Security extends Component
{
    ...
    public $scrt_id,$name,$email,$mobile,$gender,$area,$city,$state,$address,$pin,$status,$password,$supervised_by,$ids, $sec_id, $secdate, $latitude, $longitude, $trackdtl,$panno, $adhaarno,$bankname,$bankacno,$ifsccode, $scrtVal, $location, $clnt_id,$search_customer,$dropdown,$customer_dropdown1,$search_customer1;
  ...
  public function customer_dropdown1()
    ...
    public function editSecurity($id){
        ...
        $this->supervised_by = $security->select_id;
