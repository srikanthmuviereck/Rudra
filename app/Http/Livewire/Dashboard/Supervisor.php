...
{
    public $spvr_id,$name,$email,$mobile,$gender,$area,$city,$state,$address,$pin,$status,$password, $panno,$adhaarno,$bankname,$bankacno,$ifsccode,$esino, $uan,$clnt_id, $location,$search_customer,$dropdown,$customer_dropdown1,$search_customer1,$b_name;
