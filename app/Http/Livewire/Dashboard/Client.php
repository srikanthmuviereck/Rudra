...
class Client extends Component
{
    ...
    {
        $customer_list = DB::table('client')
            ->orWhere('c_name', 'like', '%' . $this->search_customer . '%')->get();
            // dd($customer_list);
            return view('livewire.dashboard.client',['customer_list' => $customer_list])->extends('layouts.main');
    }
